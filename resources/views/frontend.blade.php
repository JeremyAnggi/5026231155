...
<html lang="en">
    <head>
        ...
        <title>Jeremy Anggi | 5026231155</title>
        <!-- Favicon-->
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="#!">Jeremy Anggi | 5026231155</a>
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <div class="col mb-5">
                        <div class="card h-10 bg-light bg-gradient">
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="https://youtu.be/b683ai2pWfI">Open</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                    ...
                    <div class="col mb-5">
                        <div class="card h-10">
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="linktree">Open</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-10 bg-light bg-gradient">
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="js1">Open</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-10 bg-light bg-gradient">
                           <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Javascript 2</h5>
                                    <!-- Product price-->
                                    js2
                                </div>
                            </div>
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="js2">Open</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">Copyright &copy; Jeremy Anggi 2025</p></div>
        </footer>
        <!-- Bootstrap core JS-->
